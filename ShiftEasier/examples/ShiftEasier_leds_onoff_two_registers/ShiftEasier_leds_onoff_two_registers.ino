...
void loop()
{
  ...
  delay(100);  
  shiftout.Write(PIN_2_0, HIGH);
  delay(100);
  shiftout.Write(PIN_2_1, HIGH);
  delay(100);
  shiftout.Write(PIN_2_2, HIGH);
  delay(100);
  shiftout.Write(PIN_2_3, HIGH);
  delay(100);
  shiftout.Write(PIN_2_4, HIGH);
  delay(100);
  shiftout.Write(PIN_2_5, HIGH);
  delay(100);
  shiftout.Write(PIN_2_6, HIGH);
  delay(100);
  shiftout.Write(PIN_2_7, HIGH);
  delay(100); 
  ...
  delay(100);    
  shiftout.Write(PIN_2_0, LOW);
  delay(100);
  shiftout.Write(PIN_2_1, LOW);
  delay(100);
  shiftout.Write(PIN_2_2, LOW);
  delay(100);
  shiftout.Write(PIN_2_3, LOW);
  delay(100);
  shiftout.Write(PIN_2_4, LOW);
  delay(100);
  shiftout.Write(PIN_2_5, LOW);
  delay(100);
  shiftout.Write(PIN_2_6, LOW);
  delay(100);
  shiftout.Write(PIN_2_7, LOW);
  delay(100); 
}
